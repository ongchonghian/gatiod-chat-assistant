...
export const SYSTEM_SYNONYMS: SystemSynonym[] = [
  ...
  { term: "legs", system: "lower_limb", confidence: 0.9 },
  { term: "both legs", system: "lower_limb", confidence: 1.0 },
  { term: "leg loss", system: "lower_limb", confidence: 1.0 },
  { term: "leg amputation", system: "lower_limb", confidence: 1.0 },
  ...
  { term: "equilibrium", system: "cns", confidence: 1.0 },
  { term: "vestibular", system: "cns", confidence: 1.0 },
  { term: "balance disorder", system: "cns", confidence: 1.0 },
  { term: "balance impairment", system: "cns", confidence: 1.0 },
