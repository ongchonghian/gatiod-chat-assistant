// renal Excel shadow runner — calibration + ADR-0001 threshold enforcement.
...
maybe("renal Excel shadow runner — calibration sample", () => {
  let report: SystemCalibrationReport;

  beforeAll(async () => {
    report = await runSystemShadowSample("renal");
  }, 900_000);
