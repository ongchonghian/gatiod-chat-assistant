// respiratory Excel shadow runner — calibration + ADR-0001 threshold enforcement.
...
maybe("respiratory Excel shadow runner — calibration sample", () => {
  let report: SystemCalibrationReport;

  beforeAll(async () => {
    report = await runSystemShadowSample("respiratory");
  }, 900_000);
  ...
  it("meets ADR-0001 thresholds (90%, 80%)", () => {
